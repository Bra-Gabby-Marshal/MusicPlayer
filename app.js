...
// Creation An Object Of Audio

let audio = new Audio();
let currentSong = 0;

//whenever the window load, song should play automaticaly
...
volumeUp.addEventListener("click", function(){
	if(audio.volume === 1){
		...
		audio.volume = 1;
		documnet.querySelector(".volume-up i").className = "fa fa-volume-up";
	}
});